/*
 * $ java-algs4 RandomPoints 1000000 77 | java-algs4 SPGeoGraphT .0015 .1 .1 .9 .9
 * Time to read data and produce geometric graph: 8.859
 * Time to build DijkstraSPX object: 0.518
 * Number of vertices in shortest-paths tree: 350746
 * Length of path: 1.2628249354
 * $ java-algs4 RandomPoints 1000000 77 > tmp; java-algs4 SPGeoGraphT .0015 .1 .1 .9 .9 tmp; rm tmp
 * Time to read data and produce geometric graph: 8.787
 * Time to build DijkstraSPX object: 0.642
 * Number of vertices in shortest-paths tree: 350746
 * Length of path: 1.2628249354
 * $ java-algs4 RandomPoints 2000000 77 > tmp; java-algs4 SPGeoGraphT .001 .1 .1 .9 .9 tmp; rm tmp
 * Time to read data and produce geometric graph: 17.05
 * Time to build DijkstraSPX object: 1.457
