 ...
 * Data: 11/05/2024
 * 
 * O código a seguir é uma versão modificada do programa RedBlackBST de
 * Sedgewick & Wayne. Com algumas alterações na inserção de chaves à ARNE,
 * conseguimos alcançar as funções height, height23, ipl, sizeR e aveRedLinks
 * com complexidade de tempo constante, muito melhor do que as funções plain,
 * cujas complexidades são lineares ou piores. As modificações foram realizadas
 * com bases nos estudos de árvores binárias em sala de aula, nos algoritmos de
 * Sedgewick & Wayne e em estudos sobre recursão na disciplina MAC0323. 
 *
...
public class RedBlackBSTMod<Key extends Comparable<Key>, Value> {
    ...
    private class Node {
        ...
        //******************************************************/
        //                   VARIÁVEIS DO E06                  //
        private int height = 0;    // ALTURA DO NÓ
        private int height23 = 0;  // ALTURA BITERNÁRIA DO NÓ
        private int ipl = 0;       // INTERNAL PATH LENGTH DO NÓ
        //******************************************************/
    ...
    ***************************************************************************/
    ...
    private Node put(Node h, Key key, Value val) { 
        ...
        if (isRed(h.left)  &&  isRed(h.left.left)) {
            ...
            h.height23 = Math.max(height23(h.left), height23(h.right));
        }
        ...
        h.ipl = h.size - 1 + ipl(h.left) + ipl(h.right);
    ...
    ***************************************************************************/
    ...
    private Node rotateRight(Node h) {
        ...
        h.ipl = h.size - 1 + ipl(h.left) + ipl(h.right);
        x.ipl = x.size - 1 + ipl(x.left) + ipl(x.right);
    ...
    ***************************************************************************/
    ...
    // ALTURA BITERNÁRIA
    public int height23() {
        return height23(root);
    }

    private int height23(Node x){
        if(x == null) return -1;
        return x.height23;
    }
    ...
    public static void main(String[] args) { 
        ...
        StdOut.println("2-3 height = " + st.height23P());
        StdOut.println("Plain height = " + st.heightP());
        StdOut.println("IPL = " + st.iplP());
        StdOut.println("No. red links = " + st.sizeRP());
        StdOut.printf("Average no. of red links to an external node = %.4f\n", st.aveRedLinksP());

        //StdOut.println("Fast 2-3 height = " + st.height23());
        //StdOut.println("Fast Plain height = " + st.height());
        //StdOut.println("Fast IPL = " + st.ipl());
        //StdOut.println("Fast No. red links = " + st.sizeR());
        //StdOut.printf("Fast Average no. of red links to an external node = %.4f\n", st.aveRedLinks());
    }
}
