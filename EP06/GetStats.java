/*
 * $ java-algs4 GetStats 10000 1 88888888
 * 1000:
 *   8.494
 *   14
 *   7
 ...
 *   25.6
 *   2.708629137086291
 * $ java-algs4 GetStats 100000 10 88888888 > 10_runs.txt
 */
...
public class GetStats
{
	...
	for (int i = 0; i < N; i++) {
		...
		StdOut.println(M + ":");
		StdOut.println("  " + (double)st.ipl() / M);
		StdOut.println("  " + st.height());		
		StdOut.println("  " + st.height23());
		StdOut.println("  " + 100.0 * st.sizeR() / M);
		StdOut.println("  " + st.aveRedLinks());
	    }
	}
    }
