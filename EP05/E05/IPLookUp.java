...
public class IPLookUp {
	...
	// Use a SET object to keep IPs that are not found in the
	// given database.  For SET, see
	// https://algs4.cs.princeton.edu/35applications/ and
	// https://algs4.cs.princeton.edu/lectures/keynote/35SearchingApplications.pdf.
